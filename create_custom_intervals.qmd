...
```{r}
#| label: remove inapplicable data rows
...
```{r}
#| label: Take a p10 and a p90 value from each distribution (1 per strategy)
...
```{r}
#| label: reinflate annualised values to actual horizon distance
